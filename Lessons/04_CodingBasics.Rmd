...
vector1[3] # the third element in vector1

# Matrices ----
matrix1 <- matrix(1:20, nrow = 5,ncol = 4) # create a matrix from 1 to 20, make 5 rows and 4 columns (goes vertically/by column)
matrix1
matrix2 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE) # create a matrix from 1 to 20, make 5 rows and 4 columns, run by row (horizontally first)
matrix2
matrix3 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE, # return after comma continues the line
                  dimnames = list(c("uno", "dos", "tres", "cuatro", "cinco"), 
                                  c("un", "deux", "trois", "cat"))) # name the rows and columns
matrix3

matrix1[4, ] # show row 4 of matrix1
matrix1[ , 3] # show colum 3 of matrix1
matrix1[c(12, 14)] # show elements 12 and 14 (R will still find the elements vertically/by column)
matrix1[c(12:14)] # show elements between 12 to 14
matrix1[2:4, 1:3] # show section between row 2 to 4 and column 1 to 3

cells <- c(1, 26, 24, 68)
rnames <- c("R1", "R2")
cnames <- c("C1", "C2") 
matrix4 <- matrix(cells, nrow = 2, ncol = 2, byrow = TRUE,
  dimnames = list(rnames, cnames)) # create matrix fo cells (vectors), with 2 rows and 2 columns, run by row, name dimensions by rnames and cnames
matrix4
...
names(dataframe1) <- c("ID","Color","Passed"); View(dataframe1) # name dataframe columns

dataframe1[1:2] # show columns 1 to 2 (in matrix, it would show the first two elements)
dataframe1[c("ID","Passed")] # show columns ID and Passed
dataframe1$Color # show the specific column
