...
# Data summaries for nutrient data (also show the result of the filtered columns as 0)
...
NTL.nutrient.data.PeterPaul.gathered <- gather(NTL.nutrient.data.PeterPaul.skinny, "nutrient", "concentration", tn_ug:po4) # put column name in nutrient and the result of the 5 columns in concentration, fill with NA
