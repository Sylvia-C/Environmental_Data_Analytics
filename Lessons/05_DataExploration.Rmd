...
# Because it's specific to one computer
...
# It would show the table in the console
...
class(USGS.flow.data) #data type
...
length(USGS.flow.data) #number of columns, the width?

head(USGS.flow.data) #the first couple of rows, default is 6
